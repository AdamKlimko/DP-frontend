...
} from '../../../manufacturing/product-reservation/product-reservation-dialog/product-reservation-dialog.component';
...
} from '../../../manufacturing/production-order/production-order-dialog/production-order-dialog.component';
import {
  ProductSelectionDialogComponent,
} from '../../../storage/product/product-selection-dialog/product-selection-dialog.component';
